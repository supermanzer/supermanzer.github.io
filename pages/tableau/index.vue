<template>
  <v-container>
    ...
    <v-row align="center" justify="center" ref="tableau">
      <v-col
        cols="12"
        sm="12"
        md="6"
...
<script>
import VizPreviewCard from "@/components/tableau/VizPreviewCard";
export default {
  name: "TableauIndex",
  components: {
    VizPreviewCard,
  ...
  created() {
    this.$store.dispatch("tableau/loadVizzes");
  },
  computed: {
    vizzes() {
      return this.$store.state.tableau.vizzes;
    },
  },
};
</script>
